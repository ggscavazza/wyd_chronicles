...
- [ ] **[Issue #17]** Implementar sistema de Auto-Agrupamento (Autostack 120x) no Inventário (Consumíveis, Âmagos, Jóias, Pedras da Luz/Sábio e Itens de Quest XP agrupam até 120x; Ovos e Equipamentos permanecem individuais).
...
- [ ] **[Issue #16]** Desenvolver a Central da Guilda dos Aventureiros em Armia (Ferreiro Mestre com troca de 10 Restos por 1 Poeira a 1kk Gold + Lotes de PAC, Leilão, Alquimia e Quadro de Encomendas de Jogadores).
